...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyclibrary-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13685&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyclibrary-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyclibrary` can be installed with:

```
conda install pyclibrary
```

It is possible to list all of the versions of `pyclibrary` available on your platform with:
